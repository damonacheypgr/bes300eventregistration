...
namespace EventsAPI.Controllers
{
       ...
       // [HttpPut("{id:int}/participants/{participantId:int}")]
        ...
        public async Task<ActionResult> Get([FromQuery] bool showPast = false)
        {
            ...
            var details = await _context.Events
                ...
                .Select(e => new GetEventsResponseItem(e.Id, e.Name, e.LongDescription, e.HostedBy, e.StartDateAndTime, e.EndDateAndTime, e.Participants.Count()))
                .ToListAsync();
    ...
    public record GetEventsResponseItem(int Id, string Name, string LongDescription, string HostedBy, DateTime StartDate, DateTime EndDate, int NumberOfParticipants);
